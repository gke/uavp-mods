                ...
                else 
                {
                    switch (Convert.ToInt16(register.Command.Substring(9))) 
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            mainForm.HorizDamping2NumericUpDown.Value = Convert.ToInt16(register.Value);
                            parameterForm2[3].Value = register.Value;
                            feldUpdaten(mainForm.HorizDamping2NumericUpDown, mainForm);
                            break;
                        case 5:
                            if (Convert.ToInt16(register.Value) <= 0) 
                            {
                        ...
                        case 20:
                            parameterForm1[19].Value = register.Value;
                            mainForm.HoverThrottle2NumericUpDown.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.HoverThrottle2NumericUpDown, mainForm);
                            break;
                        case 21:
                        ...
                        case 39:
                            ...
                            mainForm.GPSGain2NumericUpDown.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.GPSGain2NumericUpDown, mainForm);
                            break;
                        default: break; // up to case 64 available
                    }
                }
