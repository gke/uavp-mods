...
for %%p in (%PROC%) do for %%g in (%GYRO%) do for %%e in (%ESC%) do for %%d in (%DBG%) do for %%r in (%RX%) do for %%c in (%CFG%) do call makeallhelper.bat %VERSION% %%p %%g %%e %%d %%r %%c
...
for %%p in (%PROC%) do for %%g in (%GYRO%) do for %%e in (%ESC%) do for %%r in (%RX%) do call makealltesthelper.bat %VERSION% %%p %%g %%e %%r
