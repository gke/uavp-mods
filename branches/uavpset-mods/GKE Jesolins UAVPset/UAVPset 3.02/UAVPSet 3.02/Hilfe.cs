...
namespace UAVP.UAVPSet
{
    ...
    static class Hilfe
    {
        ...
        static public void info(FormMain mainForm)
        {
                ...
                if (mainForm.HorizDamping1NumericUpDown.Focused || mainForm.HorizDamping2NumericUpDown.Focused)
            ...
            // General
                ...
                if (mainForm.HoverThrottle1NumericUpDown.Focused || mainForm.HoverThrottle2NumericUpDown.Focused)
                ...
                if (mainForm.GPSGain1NumericUpDown.Focused || mainForm.GPSGain2NumericUpDown.Focused)
