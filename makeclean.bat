...
set CSRC=leds stats eeprom math params accel adc uavx irq lisl prog rangefinder compass baro gyro i2c serial telemetry menu control  gps autonomous utils tests outputs
set ASRC=bootl18f
