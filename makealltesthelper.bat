...
set CSRC=adc irq lisl prog pu-test sensor accel serial i2c menu-test utils gps autonomous
set ASRC=bootl18f
...
%LEXE% %LCMD% %F% /u_CRUNTIME /z__MPLAB_BUILD=1 /W /o %PROC%\UAVPTest-V%VERSION%%PROC%%X%-%T%%G%%R%%E%.hex >> log.lst 
